...
class _PosPageState extends State<PosPage> {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: FilledButton.icon(
              onPressed: ready ? () => _complete(context, total, payingNow, staff) : null,
  ...
  void _complete(BuildContext context, double total, double payingNow, StaffStore staff) {
    ...
    final invoice = billing.createInvoice(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text('Total ${Formatters.peso(invoice.total)}'),
            Text('Paid ${Formatters.peso(invoice.amountPaid)}'),
            Text('Balance ${Formatters.peso(invoice.balance)}',
